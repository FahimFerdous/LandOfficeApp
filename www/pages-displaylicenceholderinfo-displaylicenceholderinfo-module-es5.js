                ...
                var filteredUserInfo = _this.licenceId
                    ? _this.userInfos.filter(function (p) {
                        return p.pourosovaId
                            ...
                            p.licenceNo
                                .toLowerCase()
                                .includes(_this.licenceId.toLowerCase());
                    })
                    : _this.userInfos;
                                ...
                                buttons: [
                                    {
                                        text: "ইমেইল",
                                        handler: function () {
                                            _this.router.navigate(["/paymentprocedure/", 1, userUniCode, key, motDabi]);
                                        }
                                    },
                                    {
                                        text: "ডাকযোগে",
                                        handler: function () {
                                            _this.router.navigate(["/paymentprocedure/", 2, userUniCode, key, motDabi]);
                                        }
                                    },
                                    {
                                        text: "উপজিলা বহুমি অফিস হতে",
                                        handler: function () {
                                            _this.router.navigate(["/paymentprocedure/", 3, userUniCode, key, motDabi]);
                                        }
                                    },
                                    {
                                        text: "Cancel",
