...
var PaymentprocedurePageModule = /** @class */ (function () {
    function PaymentprocedurePageModule() {
    }
    ...
    return PaymentprocedurePageModule;
}());
...
var PaymentprocedurePage = /** @class */ (function () {
    function PaymentprocedurePage(route, submittaxformService, userInfoService, authServic, afAuth, router) {
        this.route = route;
    ...
    PaymentprocedurePage.prototype.ngOnInit = function () {
        ...
        if (this.key != "") {
            this.userInfoService
                ...
                x["key"] = d.key;
                _this.userInfo.push(x);
            });
        }
    };
    PaymentprocedurePage.prototype.typeofGettingRecit = function () {
        var _this = this;
        var gettingReciType = {
            paymentTypeName: "",
            userUniCode: "",
        ...
        var userUniCode = this.route.snapshot.paramMap.get("userUniCode");
        if (this.id == "1") {
        ...
        if (this.key != "") {
            ...
            this.userInfoService.save(obj).then(function (t) {
                _this.router.navigate(["/submittaxform/", t.key]);
                console.log(t.key);
            });
        }
    };
    PaymentprocedurePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-paymentprocedure-paymentprocedure-module-es5.js.map