...
let SchedulePage = class SchedulePage {
    constructor(alertCtrl, confData, loadingCtrl, modalCtrl, router, toastCtrl, user, inAppBrowser, platform) {
...
let SpeakerListPage = class SpeakerListPage {
    constructor(actionSheetCtrl, confData, inAppBrowser, router, platform) {
