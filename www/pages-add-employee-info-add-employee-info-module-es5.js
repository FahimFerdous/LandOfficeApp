...
var AddEmployeeInfoPageModule = /** @class */ (function () {
    function AddEmployeeInfoPageModule() {
    }
    ...
    return AddEmployeeInfoPageModule;
}());
...
var AddEmployeeInfoPage = /** @class */ (function () {
    function AddEmployeeInfoPage(Addempinfo, toastController, afAuth, route, router) {
    ...
    AddEmployeeInfoPage.prototype.save = function (Addemp) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.Addempinfo.startUpLoad(Addemp)];
                    case 1:
                        _a.sent();
    ...
    AddEmployeeInfoPage.prototype.uploadFile = function (event) {
    ...
    AddEmployeeInfoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-add-employee-info-add-employee-info-module-es5.js.map