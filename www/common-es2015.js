...
let AddempinfoService = class AddempinfoService {
    constructor(db, storage, toastController) {
        this.db = db;
    ...
    startUpLoad(empInfo) {
        ...
        this.snapshot = this.task.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield ref.getDownloadURL().toPromise().then(t => {
                empInfo.imageUrl = t;
...
AddempinfoService.ctorParameters = () => [
...
let HatService = class HatService {
    constructor(db) {
        this.db = db;
    }
    save(pourosova) {
...
let LicenceService = class LicenceService {
    constructor(db) {
        this.db = db;
    }
    save(licence) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return yield this.db.list('/licenceNo').push(licence);
        });
    }
    getAllLicense() {
...
let PourosovaService = class PourosovaService {
    constructor(db) {
        this.db = db;
    }
    save(pourosova) {
...
PourosovaService.ctorParameters = () => [
    { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
];
...
let UserInfosService = class UserInfosService {
    ...
    save(userInfo) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return yield this.db.list('/userInofs').push(userInfo);
        });
    }
    update(key, userInfo) {
...
UserInfosService.ctorParameters = () => [
    { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
];
...
let SubmittaxformService = class SubmittaxformService {
    constructor(db) {
        this.db = db;
    }
    getTempUserInfo(userUniCode) {
        return this.db.list('/tempUserInfoForPayment/', ref => ref
            .orderByChild('userUniCode')
            .equalTo(userUniCode))
            .snapshotChanges()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null)));
    }
...
SubmittaxformService.ctorParameters = () => [
    { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
];
