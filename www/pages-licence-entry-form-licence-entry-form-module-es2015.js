...
let LicenceEntryFormPageModule = class LicenceEntryFormPageModule {
};
...
let LicenceEntryFormPage = class LicenceEntryFormPage {
    constructor(pourosovaServices, hatService, licenceServices, toastController) {
    ...
    save(licence) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log(licence);
            yield this.licenceServices.save(licence).then(t => {
...
LicenceEntryFormPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-licence-entry-form-licence-entry-form-module-es2015.js.map